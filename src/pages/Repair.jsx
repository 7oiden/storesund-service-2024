...
export default function Repair() {
  return (
    <>
      ...
      >
        <p>
          I mange tilfeller kan et problem med varmepumpen løses med en rimelig
          og enkel reparasjon, i stedet for å måtte bytte ut hele anlegget, der
          man i tillegg til kostnaden for en ny varmepumpe også vil få et
          betydelig utlegg ny montering.
        </p>
        <p>
        ...
        <p>
          Dersom reparasjon likevel skulle vise seg å ikke være regningssvarende
          er jeg behjelpelig med en prisgunstig erstatning. Jeg har avtale med
          flere leverandører.
        </p>
        <p>
